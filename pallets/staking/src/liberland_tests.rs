    ...
    ExtBuilder::default().build_and_execute(|| {
        ...
        assert_eq!(
            ...
            StakingLedger {
                ...
                total: 10,
                active: 7,
                unlocking: vec![UnlockChunk { value: 3, era: 3 }],
                claimed_rewards: vec![],
                polka_amount: 3,
                liber_amount: 7,
            }
        ...
        //         BalanceLock {
        //             id: POLKADOT_STAKING_ID,
        //             amount: 0, // FIXME this is not true we need fix withdraw_unbonded
        //             reasons: Reasons::All
        //         }
        //     ]
        // );
